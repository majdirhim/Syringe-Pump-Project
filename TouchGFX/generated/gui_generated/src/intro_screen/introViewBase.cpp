...
introViewBase::introViewBase() :
    waitCounter(0),
    apearEndedCallback(this, &introViewBase::apearEndedCallbackHandler),
    moveEndedCallback(this, &introViewBase::moveEndedCallbackHandler)
{
...
void introViewBase::apearEndedCallbackHandler(const touchgfx::FadeAnimator<touchgfx::MoveAnimator<touchgfx::ScalableImage> >& comp)
{
    //paramRequest
...
void introViewBase::moveEndedCallbackHandler(const touchgfx::MoveAnimator<touchgfx::ScalableImage>& comp)
{
    //gotostartup
    //When move completed call virtual function
    //Call initsystem
    initsystem();
}
