...
timeparamViewBase::timeparamViewBase() :
    buttonCallback(this, &timeparamViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &timeparamViewBase::flexButtonCallbackHandler)
{
    ...
    textareahourcaption.setTypedText(touchgfx::TypedText(T___SINGLEUSE_AOZX));
    ...
    Unicode::snprintf(textaearHourBuffer, TEXTAEARHOUR_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_PAYO).getText());
    textaearHour.setWildcard(textaearHourBuffer);
    textaearHour.setTypedText(touchgfx::TypedText(T___SINGLEUSE_9T7A));
    ...
    textareaminutecaption.setTypedText(touchgfx::TypedText(T___SINGLEUSE_B7HK));
    ...
    Unicode::snprintf(textAreaminuteBuffer, TEXTAREAMINUTE_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_4I37).getText());
    textAreaminute.setWildcard(textAreaminuteBuffer);
    textAreaminute.setTypedText(touchgfx::TypedText(T___SINGLEUSE_HE2Y));
    ...
    buttonclock.setLabelText(touchgfx::TypedText(T___SINGLEUSE_IDXQ));
    ...
    btn_Back.setText(TypedText(T___SINGLEUSE_Y2ZT));
...
void timeparamViewBase::setupScreen()
{
    customContainer11.initialize();
    customContainer11_1.initialize();
}

void timeparamViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &buttonhourup)
    {
        //Interaction1
    ...
    else if (&src == &buttonclock)
    {
        ...
        //Interaction7
        //When Interaction5 completed change screen to mainScreen_WithSTART
        //Go to mainScreen_WithSTART with no screen transition
        application().gotomainScreen_WithSTARTScreenNoTransition();
    }
}

void timeparamViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &btn_Back)
    {
        //Interaction6
